...
class PublicUserApiTests(TestCase):
    ...
    def test_create_valid_user_201(self):
    ...
    def test_create_token_for_user_200(self):
        """Test that a token is created for the user"""
        payload = {"email": "test@test.com", "password": "pw123456789"}
        create_user(**payload)
    ...
    def test_retrieve_user_unauthorised_401(self):
...
class PrivateUserApiTests(TestCase):
    ...
    def test_retrieve_profile_success_200(self):
    ...
    def test_post_me_not_allowed_405(self):
        """Test that POST is  ot allowed on the me url"""
    ...
    def test_update_user_profile_200(self):
        ...
        payload = {"name": "Terry Test", "password": "password123"}
